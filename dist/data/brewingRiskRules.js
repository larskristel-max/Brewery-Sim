const includesAny = (recipe, matches) => {
...
export const brewingRiskRuleSet = {
    validationStatus: 'brewer-approved',
...
export const brewdayRiskForRecipe = (recipe, approach) => {
    if (approach === 'careful')
        return brewingRiskRuleSet.brewdayApproach.careful;
    if (approach === 'standard')
        return brewingRiskRuleSet.brewdayApproach.standard;
...
export const transferRiskForRecipe = (recipe, mode) => {
    if (mode === 'careful')
        return brewingRiskRuleSet.transferMode.careful;
...
export const packagingRiskForMode = (mode) => brewingRiskRuleSet.packagingMode[mode];
export const recipeMatchesBrewingRisk = (recipe, matches) => includesAny(recipe, matches);
//# sourceMappingURL=brewingRiskRules.js.map