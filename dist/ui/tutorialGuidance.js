...
export const renderNextTapBadge = (nextTap, target) => nextTap ? `<span class="next-tap-badge"><b>Next</b>${tutorialTargetLabel(target)}</span>` : '';
const tutorialLesson = (state) => {
...
export const renderTutorialLesson = (state, guidanceDismissed) => {
...
export const renderPhoneEconomyCard = (state) => {
...
//# sourceMappingURL=tutorialGuidance.js.map