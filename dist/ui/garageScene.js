import { garageEquipmentLayoutByItem, garageSellPointLayout } from '../data/garageLayout.js';
import { campaignAllowsPressure, campaignPrimaryTarget } from '../game/campaign.js';
import { currentWorkflowStage, equipmentConditionTier, storageCapacityByArea, storageOverflowByArea, storageUseByArea } from '../game/selectors.js';
import { renderLayoutDebugPanel } from './layoutDebug.js';
...
const renderEquipmentObject = (context, equipment, content) => {
...
const hotspotPosition = (state, equipmentId) => {
...
const shouldShowStorageHotspot = (state, area, used, capacity, overflow) => {
...
const renderSceneSupplyHotspots = (state) => {
...
const renderWorkshopHotspot = (state) => {
...
const renderGaragePressure = (state) => {
...
const renderFinishedBeerPallet = (context) => {
...
const renderOpsControl = ({ opsOpen, saveStatus }) => `
...
`;
const renderAtmosphere = (context) => {
...
export const renderGarage = (context) => {
    ...
    const equipment = sceneEquipment
        ...
        const obstructed = context.expandedTarget === 'fermenter'
        ...
        return renderEquipmentObject(context, item, `
          <button
...
//# sourceMappingURL=garageScene.js.map