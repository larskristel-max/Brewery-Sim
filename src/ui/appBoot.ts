import type { EquipmentItemId, GameState } from '../game/schema.js';
...
export const hasBrowserSave = (): boolean => {
  try {
...
export const createTier2PreviewState = (): GameState => {
...
export const createBootState = (): BootState => {
