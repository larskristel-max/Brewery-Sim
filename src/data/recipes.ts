...
export const recipes: Recipe[] = [
  {
    ...
    name: 'Garage Blonde',
    style: 'Blonde',
    description: 'A Belgian-style blond garage beer: golden, dry, lightly spicy and friendly enough for the first promise.',
    ingredients: [
      { ingredientId: 'pilsner-malt', amount: 4.7 },
      { ingredientId: 'aromatic-malt', amount: 0.3 },
      { ingredientId: 'candi-sugar', amount: 0.5 },
      { ingredientId: 'styrian-hops', amount: 50 },
      { ingredientId: 'belgian-yeast', amount: 1 },
    ...
    riskTags: ['young beer', 'rushed fermentation', 'Belgian yeast character'],
    challenge: 'Approachable and forgiving, but Belgian yeast still needs time to clean up before packaging.',
    originalGravity: '1.062',
    expectedAbv: '6.4%',
    wortNote: 'Golden, lightly honeyed wort. It should smell bready and sweet before the Belgian yeast takes over.',
    brewNote: 'The mash builds a pale malt base, candi sugar keeps the finish dry, and Belgian ale yeast should add gentle citrus and spice.',
    enabled: true,
